...
class RNN(nn.Module):
    ...
    def __init__(self, vocab_size=95811, embed_size=300, num_output=4, rnn_model='LSTM', use_last=True, embedding_tensor=None,
    ...
    def forward(self, x, seq_lengths=100):
        '''
        Args:
        ...
        packed_input = pack_padded_sequence(x_embed, seq_lengths.numpy(),batch_first=True)
