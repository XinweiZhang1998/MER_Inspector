...
# Ref: https://github.com/facebookresearch/LeViT/blob/main/levit.py
...
specification = {
    ...
    'LeViT_128': {
        'C': '128_256_384', 'D': 16, 'N': '4_8_12', 'X': '4_4_4', 'drop_path': 0.1,
        'weights': 'https://dl.fbaipublicfiles.com/LeViT/LeViT-128-b88c2750.pth'},
    'LeViT_192': {
        'C': '192_288_384', 'D': 32, 'N': '3_5_6', 'X': '4_4_4', 'drop_path': 0.1,
        'weights': 'https://dl.fbaipublicfiles.com/LeViT/LeViT-192-92712e41.pth'},
    'LeViT_256': {
        'C': '256_384_512', 'D': 32, 'N': '4_6_8', 'X': '4_4_4', 'drop_path': 0.1,
...
@register_model
def levit_128s(num_classes=10, distillation=False,
...
#num=8
def levit_128(num_classes=10, distillation=False,
              pretrained=False, pretrained_cfg=None, fuse=False):
    return model_factory(**specification['LeViT_128'], num_classes=num_classes,
                         distillation=distillation, pretrained=pretrained, fuse=fuse)

# def LeViT_128(num_classes=10, distillation=True,
#               pretrained=False, pretrained_cfg=None, fuse=False):
#     return model_factory(**specification['LeViT_128'], num_classes=num_classes,
#                          distillation=distillation, pretrained=pretrained, fuse=fuse)
...
@register_model
def levit_192(num_classes=10, distillation=False,
              pretrained=False, pretrained_cfg=None, fuse=False):
...
@register_model
def levit_256(num_classes=10, distillation=False,
              pretrained=False, pretrained_cfg=None, fuse=False):
    print("num_classes",num_classes)
...
@register_model
def levit_384(num_classes=10, distillation=False,
              pretrained=False, pretrained_cfg=None, fuse=False):
    print("num_classes",num_classes)
...
def b16(n, activation, resolution=224):
    return torch.nn.Sequential(
        Conv2d_BN(3, n // 8, 3, 2, 1, resolution=resolution),  # 第一个改成1 for FMNIST
        activation(),
...
class LeViT(torch.nn.Module):
    ...
    def __init__(self, img_size=32, # 96 for STL-10, 32 for CIFAR, FMNIST: 28, 64 for Celea
                 patch_size=16,  #FMNIST:14; others:16
                 in_chans=3, #FMNIST:1; others:3
                 num_classes=10,
                 embed_dim=[192],
                 key_dim=[64],
                 depth=[12],
