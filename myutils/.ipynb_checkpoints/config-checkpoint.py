...
parser.add_argument(
    "--model_tgt", type=str, default="wres22", help="Target Model[res20/wres22/conv3]"
)
parser.add_argument("--pretrained", action="store_true", help="Use Pretrained model")
parser.add_argument("--adv_train", action="store_true", help="Use adversarial training")
parser.add_argument("--eps_adv", type=float, default=0.001, help="epsilon for adv train")
...
parser.add_argument("--opt", type=str, default="adam", help="Optimizer [adam/sgd], sgd needs larger learning rate")
parser.add_argument(
